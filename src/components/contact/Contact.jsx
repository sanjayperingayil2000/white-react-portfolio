...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_nks3mbd', 'template_71w7use', form.current, {
        publicKey: 'wPqQQ0X7uur7TX4gM',
      })
      e.target.reset();
  };
            ...
            <div className='contact__content'>
                ...
                <div className='contact__info'>
                    <div className='contact__card'>
                        ...
                        <span className='contact__card-data'>sanjayperingayil@gmail.com</span>
                    ...
                    <div className='contact__card'>
                        ...
                        <span className='contact__card-data'>+971-588-393-705</span>

                        <a href="https://api.whatsapp.com/send?phone=971588393705&text=Hello, more information!" className='contact__button'>Write me {" "}
                        <i className='bx bx-arrow-right contact__button-icon'></i>
                        </a>
                    </div>
                    ...
                    {/* <div className='contact__card'>
                        ...
                        <span className='contact__card-data'>Sanjay peringayil</span>
